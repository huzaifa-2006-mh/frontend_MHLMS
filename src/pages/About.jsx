...
function About() {
  return (
    <div className="app-container">
      ...
      <div className="page-container" style={{maxWidth: '800px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center'}}>
        <h1 style={{fontSize: '3.5rem', marginBottom: '1.5rem', color: 'white'}}>Our Mission at <span className="highlight">MHLMS</span></h1>
        <p style={{fontSize: '1.25rem', color: 'var(--text-muted)', lineHeight: '1.8', marginBottom: '4rem'}}>
        ...
        <div className="glass" style={{padding: '4rem', borderRadius: '24px'}}>
           ...
           <h2 style={{color: 'white'}}>Empowering Instructors & Students</h2>
           <p style={{color: 'var(--text-muted)', marginTop: '1rem', fontSize: '1.1rem', lineHeight: '1.6'}}>
